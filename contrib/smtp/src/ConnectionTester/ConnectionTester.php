...
class ConnectionTester {
   ...
   *   The module handler.
   */
  public function __construct(ConfigFactory $config_factory, LoggerInterface $logger, MailManagerInterface $mail_manager, ModuleHandlerInterface $module_handler) {
